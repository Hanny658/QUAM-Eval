...
- [Foursquare Open Source Places](https://huggingface.co/datasets/foursquare/fsq-os-places): A more recent dataset that contains POI data from Foursquare's open source places project.
